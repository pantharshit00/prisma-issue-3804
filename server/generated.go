...
type ComplexityRoot struct {
	Mutation struct {
		...
		CreateDraft func(childComplexity int, title string, userId string) int
		Publish     func(childComplexity int, postId string) int
	}
...
type MutationResolver interface {
	...
	CreateDraft(ctx context.Context, title string, userId string) (*prisma.Post, error)
	Publish(ctx context.Context, postId string) (*prisma.Post, error)
}
...
func field_Query_postsByUser_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["userId"]; ok {
		var err error
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createDraft":
		...
		return e.complexity.Mutation.CreateDraft(childComplexity, args["title"].(string), args["userId"].(string)), true
	...
	case "Mutation.publish":
		...
		return e.complexity.Mutation.Publish(childComplexity, args["postId"].(string)), true
	...
	case "Query.publishedPosts":
		if e.complexity.Query.PublishedPosts == nil {
			break
		}

		return e.complexity.Query.PublishedPosts(childComplexity), true
	...
	case "Query.postsByUser":
		...
		args, err := field_Query_postsByUser_args(rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) _Mutation_createDraft(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateDraft(rctx, args["title"].(string), args["userId"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
...
func (ec *executionContext) _Mutation_publish(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Publish(rctx, args["postId"].(string))
	})
	if resTmp == nil {
		return graphql.Null
	}
...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "publishedPosts":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_publishedPosts(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
		...
		case "postsByUser":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_postsByUser(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
...
// nolint: vetshadow
func (ec *executionContext) _Query_publishedPosts(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Query",
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().PublishedPosts(rctx)
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _Query_postsByUser(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Query_postsByUser_args(rawArgs)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().PostsByUser(rctx, args["userId"].(string))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
